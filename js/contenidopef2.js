 lucide.createIcons();
        ...
        const allSeriesContent = [
            ...
            { title: "Stargate SG-1", rating: 8.4, year: 1997, type: 'Serie', duration: "1 Temporada", image: "https://pics.filmaffinity.com/stargate_sg_1-145480884-large.jpg", inMyList: false, description: "Un equipo de exploradores compuesto de soldados y científicos viaja a través de un portal que da acceso a otros planetas. Ellos usan el paso interestelar para explorar nuevos mundos y proteger a la Tierra de fuerzas enemigas.", cast: "Ben Browder , Amanda Tapping , Christopher Judge , Michael Shanks , Claudia Black , Beau Bridges, Richard Dean Anderson", genres: ['accion', 'scifi', 'drama','aventura', 'destacada'], dateAdded: '2025-07-20', 
                seasons: [{ seasonNumber: 1, episodes: 
                    [{ episode: 1, title: "Children of the Gods", duration: "46m", thumbnail: "https://pics.filmaffinity.com/stargate_sg_1-145480884-large.jpg", description: "El coronel Jack O'Neill sale de su retiro para dirigir una nueva expedición de regreso a Abydos, solo para encontrar un viejo amigo, un nuevo enemigo y un uso mucho más amplio del Stargate.", videoUrl: "https://waaw.to/e/Er8tmWqQS9JC?http_referer=https%3A%2F%2Fwww.verseriesonline.net%2F" }]}] },
