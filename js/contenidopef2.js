 lucide.createIcons();
        ...
        const allMoviesSource = [
            { title: "IT: Bienvenidos a Derry (2025)", rating: 6.8, year: 2025, duration: "2h", type: 'serie', image: "https://la.movie/wp-content/uploads/thumbs/720e36c820ef1b1b88fb4e8c0e71cf86_hd.webp", genres: ['drama', 'misterio', 'terror', ], description: "En 1958, un grupo de siete amigos están empezando a ver cosas extrañas en el tranquilo pueblito Derry. Con el tiempo, descubren que todos estaban viendo lo mismo: un ser sobrenatural y malvado que puede adoptar muchas formas.", cast: "Jovan Adepo, Bill Skarsgård, Taylour Paige", inMyList: false, videoUrl: "https://vimeos.net/embed-s5irm151bw52.html", dateAdded: '2025-12-02' },
        ...
        const newReleasesTitles = ["IT: Bienvenidos a Derry (2025)","Caramelo", "F1 La Película", "Superman", "mision imposible 8", "Los Cuatro Fantásticos", "Elio", "Destino Final: Lazos de Sangre", "Karate Kid: Leyendas", "Jurassic World: Renace", "Primitive War", "Hipnosis: Arma Invisible", "Mi Villano Favorito 4" ];
        ...
        const popularSeriesTitles = ["IT: Bienvenidos a Derry (2025)","Shōgun", "The Boys", "Monarch: El legado de los monstruos", "Kaiju Nº 8", "From", "Wolf Pack", "Surface", "La Brea", "Wynonna Earp", "Stargate SG-1","Invasión", "Rumbo al infierno", "Outcast", "One tree hill" ];
